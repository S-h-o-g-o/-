...
// データを入力
            $sql = $pdo -> prepare("INSERT INTO forum (dname, dcomment, ddate) VALUES (:dname, :dcomment, :ddate)");
...
// データレコードの内容を編集
                $sql = 'UPDATE forum SET dname = :dname, dcomment = :dcomment, ddate = :ddate WHERE id = :id';
                $stmt = $pdo -> prepare($sql);
